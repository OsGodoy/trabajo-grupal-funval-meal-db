...
function MealRecipeCard({ item }) {
  return (
    <Link className="flex flex-col gap-1 mb-4" to={`/meal-recipe-details/${item.idMeal}`}>
      <div className="relative rounded-3xl overflow-hidden xs:h-60 ss:h-68 ms:h-74 md:h-68 lg:h-67 xl:h-75 2xl:h-140 group">
        ...
        <div className="absolute inset-0  rounded-3xl 
          ...
          <span className="px-2 py-1 rounded-b-3xl w-full text-[10px] 
        text-white  text-center bg-black/50 lg:bg-transparent
